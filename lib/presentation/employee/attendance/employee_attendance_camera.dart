...
class EmployeeAttendanceCamera extends StatefulWidget {
  const EmployeeAttendanceCamera({super.key});

  @override
  State<EmployeeAttendanceCamera> createState() => _EmployeeAttendanceCameraState();
}

class _EmployeeAttendanceCameraState extends State<EmployeeAttendanceCamera> {
  @override
  void initState() {
    super.initState();
